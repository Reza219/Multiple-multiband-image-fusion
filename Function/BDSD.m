function [M2f,time] = BDSD(p3,M3,S,Np,Nm,Km,ratio)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: 
...
%           S:              Local estimation on SxS distinct blocks; 
%           Km:             MS sensor's point-spread function;
%           Np:             Number of pixels;
%           Nm:             Number of MS bands.
%
% Outputs:
%           M2f:            Pansharpened image.
% 
% References:
...
%M3=imresize(M3u,1/ratio);        %%%%%%%%%%
M3l=imfilter(M3,Km,'circular');
