%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description:
%           interp23tap interpolates the image I using a polynomial with 23 coefficients interpolator.
%
% Interface:
%           I = interp23tap(I,ratio)
%
% Inputs:
%           I:              Image to interpolate;
...
function I = interp23tap(I,ratio)
...
CDF23 = 2.*[0.5 0.305334091185 0 -0.072698593239 0 0.021809577942 0 ...
...
for z = 1 : ratio/2
    ...
    if first
        I1LRU(2:2:end,2:2:end,:) = I;
        first = 0;
    else
        I1LRU(1:2:end,1:2:end,:) = I;
    end
